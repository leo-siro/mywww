function createCalendar(varYear, varMonth ,varYotei ,varYoteiMode){
	...
	while(i<=maxDay.getDate()+1){
		...
		WriteMsg = WriteMsg + '<tr><td colspan=\"2\" class=\"t_bg_base_ultramarine\" style=\"height:1\"></td></tr>';
		if(today.getDate()==i && today.getMonth()+1==varMonth && today.getFullYear()==varYear){
			...
			WriteMsg = WriteMsg + '<tr><td class=\"t_bg_left_ultramarine\" align=\"right\" style=\"width:20\"><font class=\"keiji_small\" color=\"white\">' + i + '</font><br></td>';
		}
		if(today.getDate()==i && today.getMonth()+1==varMonth && today.getFullYear()==varYear){
		...
		if(varYotei[i]){
			...
			WriteMsg = WriteMsg + '<a href=\"./php/calendar/main/portlet_scheduler.php?calendar_date=' + calendar_date + '&mode=' + varYoteiMode + '\">' ;
